...
func describe():
	...
	description_instance.text = tr("item_" + equipment_reference["type"] + "_title")
	description_instance.get_node("Body").text = tr("item_" + equipment_reference["type"] + "_description").format(format)
